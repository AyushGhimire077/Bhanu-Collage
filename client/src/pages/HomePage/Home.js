...
const Home = () => {
  ...
  // Define nextSlide before useEffect
  ...
  }, [currentIndex, images.length]); // Include dependencies
  ...
  return (
    <div className='home'>
      ...
      <div className="slider">
        ...
        <button onClick={nextSlide} className="next"><i className="fa fa-arrow-right"></i></button>
      </div>
